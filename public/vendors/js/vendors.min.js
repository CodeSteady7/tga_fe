...
!(function (e, t) {
	...
	;(w.fn = w.prototype =
		...
		w.extend({
			...
			makeArray: function (e, t) {
				...
				return (
					null != e &&
						(_(Object(e)) ? w.merge(n, "string" == typeof e ? [e] : e) : s.call(n, e)),
					n
				)
			},
	...
	var k = (function (e) {
		...
		function ae(e, t, i, o) {
			var r,
				...
				w = t ? t.nodeType : 9
			if (
				((i = i || []), "string" != typeof e || !e || (1 !== w && 9 !== w && 11 !== w))
			)
				return i
			if (!o && (h(t), (t = t || f), g)) {
				if (11 !== w && (p = Z.exec(e)))
		...
		(ae.uniqueSort = function (e) {
			var t,
				...
				r = 0
			if (
				((p = !n.detectDuplicates), (u = !n.sortStable && e.slice(0)), e.sort(A), p)
			) {
										...
										if (((d = [s ? m.firstChild : m.lastChild]), s && v)) {
											for (
												b =
													(f =
														(c =
															(u = (p = (h = m)[x] || (h[x] = {}))[h.uniqueID] || (p[h.uniqueID] = {}))[e] ||
															[])[0] === _ && c[1]) && c[2],
													h = f && m.childNodes[f];
											...
											(v &&
												(b = f =
													(c =
														(u = (p = (h = t)[x] || (h[x] = {}))[h.uniqueID] || (p[h.uniqueID] = {}))[e] ||
														[])[0] === _ && c[1]),
											!1 === b)
										)
											for (
												...
												((a ? h.nodeName.toLowerCase() !== y : 1 !== h.nodeType) ||
													!++b ||
													(v &&
														((u = (p = h[x] || (h[x] = {}))[h.uniqueID] || (p[h.uniqueID] = {}))[e] = [
															_,
															b,
														]),
													h !== t));
		...
		return (
			...
			(l = ae.select =
				function (e, t, n, o) {
					...
					return (
						(h || a(e, f))(o, t, !g, n, !t || (ee.test(e) && ye(t.parentNode)) || t), n
					)
				}),
		...
		var i,
			...
			p = {
				...
				fireWith: function (e, t) {
					return (
						s || ((t = [e, (t = t || []).slice ? t.slice() : t]), l.push(t), i || u()), this
					)
				},
				fire: function () {
											...
											: function () {
													try {
														...
														w.Deferred.exceptionHook && w.Deferred.exceptionHook(e, u.stackTrace),
															r <= t + 1 && (i !== H && ((a = void 0), (l = [e])), n.rejectWith(a, l))
													}
											  }
									t
										? u()
	...
	;($.uid = 1),
		($.prototype = {
			...
			remove: function (e, t) {
				...
				if (void 0 !== i) {
					if (void 0 !== t) {
						n = (t = Array.isArray(t) ? t.map(Y) : (t = Y(t)) in i ? [t] : t.match(P) || [])
							.length
						for (; n--; ) delete i[t[n]]
					}
			...
			queue: function (e, t, n) {
				...
				if (e)
					return (
						...
						(i = K.get(e, t)),
						n &&
							(!i || Array.isArray(n) ? (i = K.access(e, t, w.makeArray(n))) : i.push(n)),
						i || []
					)
			},
	...
	function ce(e, t) {
		for (var n, i, o, r, s, a, l, c = [], u = 0, p = e.length; u < p; u++)
			(i = e[u]).style &&
				...
				t
					? ("none" === n &&
							((c[u] = K.get(i, "display") || null), c[u] || (i.style.display = "")),
					  "" === i.style.display &&
							se(i) &&
							(c[u] =
								((l = s = r = void 0),
				...
				for (
					...
					for (
						...
						(l.rnamespace && !1 !== r.namespace && !l.rnamespace.test(r.namespace)) ||
							...
							(l.data = r.data),
							void 0 !==
								(i = ((w.event.special[r.origType] || {}).handle || r.handler).apply(
									o.elem,
									a
								)) &&
								!1 === (l.result = i) &&
		...
		special: {
			...
			click: {
				...
				_default: function (e) {
					var t = e.target
					return (
						(he.test(t.type) && t.click && C(t, "input") && K.get(t, "click")) || C(t, "a")
					)
				},
			},
			beforeunload: {
	...
	w.extend({
		...
		clone: function (e, t, n) {
			var i,
				...
				p = oe(e)
			if (
				!(f.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || w.isXMLDoc(e))
			)
	...
	function Ge(e, t, n) {
		var i = Ie(e),
			o =
				(!f.boxSizingReliable() || n) && "border-box" === w.css(e, "boxSizing", !1, i),
			r = o,
			s = qe(e, t, i),
	...
	function ct(e, t, n) {
		...
		for (
			...
			if ((i = ct.prefilters[r].call(c, e, u, c.opts)))
				return (
					d(i.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i
				)
		return (
			w.map(u, lt, c),
	...
	w.fn.extend({
		...
		w.each(w.expr.match.bool.source.match(/\w+/g), function (e, t) {
			...
			pt[t] = function (e, t, i) {
				...
				return (
					i ||
						((r = pt[s]), (pt[s] = o), (o = null != n(e, t, i) ? s : null), (pt[s] = r)),
					o
				)
			}
		})
		...
		trigger: function (t, n, i, o) {
			...
			if (
				...
				3 !== i.nodeType &&
					...
					(c = v.indexOf(":") < 0 && "on" + v),
					((t = t[w.expando] ? t : new w.Event(v, "object" == typeof t && t)).isTrigger =
						o ? 2 : 3),
					(t.namespace = b.join(".")),
				...
				for (r = 0; (s = y[r++]) && !t.isPropagationStopped(); )
					(f = s),
						...
						(p =
							(K.get(s, "events") || Object.create(null))[t.type] && K.get(s, "handle")) &&
							p.apply(s, n),
						(p = c && s[c]) &&
							p.apply &&
							V(s) &&
			...
			ajax: function (t, n) {
				...
				var i,
					...
					E = {
						...
						setRequestHeader: function (e, t) {
							return (
								null == c && ((e = _[e.toLowerCase()] = _[e.toLowerCase()] || e), (x[e] = t)),
								this
							)
						},
				...
				function T(t, n, s, l) {
					...
					c ||
						...
						v.fireWith(d, [E, k]),
						u &&
							(g.trigger("ajaxComplete", [E, f]), --w.active || w.event.trigger("ajaxStop")))
				}
				return E
			},
		...
		(w.parseHTML = function (e, t, n) {
			return "string" != typeof e
				...
				: ("boolean" == typeof t && ((n = t), (t = !1)),
				  t ||
						(f.createHTMLDocument
							? (((i = (t = m.implementation.createHTMLDocument("")).createElement(
									"base"
		...
		var R = ["top", "bottom", "right", "left"],
								...
								"auto" === w(n)
									? (function (e, t) {
											...
											var c = r.reduce(function (t, r) {
												return (
													(t[r] = L(e, { placement: r, boundary: n, rootBoundary: i, padding: o })[w(r)]),
													t
												)
											}, {})
					...
					if (((a = { x: 0, y: 0 }), s)) {
						if (o || r) {
							...
							;(m = C[m]),
								...
								(u =
									s[p] + T - g - (u ? ("y" === p ? u.clientTop || 0 : u.clientLeft || 0) : 0)),
								(h = s[p] + h - g),
								o &&
									((o = i ? B(_, u) : _),
									(k = i ? F(k, h) : k),
			...
			ie = {
				...
				fn: function (e) {
					...
					if (
						...
						;(s = s[e] - n.rects.reference[e]),
							(s =
								(r = (r = v(r)) ? ("y" === e ? r.clientHeight || 0 : r.clientWidth || 0) : 0) /
									2 -
								l[a] / 2 +
								(p / 2 - s / 2)),
				...
				effect: function (e) {
					var t = e.state
					if (
						null != (e = void 0 === (e = e.options.element) ? "[data-popper-arrow]" : e)
					) {
	...
	(function (e, t) {
		"object" == typeof exports && "undefined" != typeof module
			...
			: "function" == typeof define && define.amd
			? define(t)
			: ((e = "undefined" != typeof globalThis ? globalThis : e || self).bootstrap =
					t())
	})(this, function () {
		"use strict"
		const e = e => {
		...
		class H {
			constructor(e) {
				;(e = r(e)) &&
					((this._element = e), I.set(this._element, this.constructor.DATA_KEY, this))
			}
			dispose() {
		...
		class te extends H {
			...
			_getConfig(e) {
				return (
					((e = { ...Z, ...B.getDataAttributes(this._element), ...e }).toggle = Boolean(
						e.toggle
					)),
					(e.parent = r(e.parent)),
					s("collapse", e, ee),
		...
		function ve(e, t) {
			...
			return (
				fe(e) &&
					t &&
					((i = n.width / e.offsetWidth || 1), (o = n.height / e.offsetHeight || 1)),
				{
					width: ye(n.width / i),
									...
									"auto" === me(n)
										? (function (e, t) {
												...
												var f = h.reduce(function (t, n) {
													return (
														(t[n] = Je(e, { placement: n, boundary: o, rootBoundary: r, padding: s })[
															me(n)
														]),
														t
													)
		...
		class Lt {
			...
			_getConfig(e) {
				return (
					(e = { ...At, ...("object" == typeof e ? e : {}) }), s("focustrap", e, Ot), e
				)
			}
		}
		...
		class Vt extends H {
			...
			getTipElement() {
				...
				return (
					this.setContent(t), t.classList.remove("fade", "show"), (this.tip = t), this.tip
				)
			}
			setContent(e) {
	...
	(function (e, t, n, i) {
		...
		function Z(e, t) {
			return (
				((t = t || {}).recognizers = p(t.recognizers, Z.defaults.preset)), new ee(e, t)
			)
		}
		function ee(e, t) {
		...
		;(F.prototype = {
			...
			set: function (e) {
				return (
					ie(this.options, e), this.manager && this.manager.touchAction.update(), this
				)
			},
			...
			requireFailure: function (e) {
				...
				return (
					-1 === y(t, (e = X(e, this))) && (t.push(e), e.requireFailure(this)), this
				)
			},
	...
	(function () {
		...
		function e(e) {
			function t(t, i) {
				...
				if (
					...
					if (
						...
						i.showOverlay && x.show(), m && w.show(), i.onBlock && i.onBlock.bind(w)()
					if (
						(o(1, t, i),
						g
							? ((h = w[0]),
			...
			var l = e.noop || function () {},
				...
				u =
					/MSIE 6.0/.test(navigator.userAgent) && !/MSIE 8.0/.test(navigator.userAgent),
				p =
	...
	function () {
		...
		K(J, (Y = Error)),
			...
			(ne.prototype.watch = function (e) {
				...
				if (!j(e))
					return (
						(n = new ("socket" === t ? u : p)(n, this.complete)), this.elements.push(n)
					)
			}),
	...
	(function (e, t) {
		...
		function s(e) {
			...
			return (
				...
				(t =
					null !== (i = n = r) && i === i.window ? n : 9 === n.nodeType && n.defaultView),
				{
								...
								if (this.i18nFormat && this.i18nFormat.parse)
									...
									i.interpolation &&
										this.interpolator.init(
											n({}, i, { interpolation: n({}, this.options.interpolation, i.interpolation) })
										)
									var a,
										l =
							...
							value: function (e, t) {
								...
								for (
									...
									"string" != typeof o && (o = g(o)),
										o ||
											(this.logger.warn("missed to resolve ".concat(i[1], " for nesting ").concat(e)),
											(o = "")),
										u &&
				...
				r(o, [
					{
						...
						value: function () {
							...
							return (
								this.options.resources || !this.options.initImmediate ? c() : setTimeout(c, 0),
								l
							)
						},
					},
	...
	(function (e, t) {
		...
		function l(e, t, n, i, o) {
			...
			try {
				...
				;(r = XMLHttpRequest
					? new XMLHttpRequest()
					: new ActiveXObject("MSXML2.XMLHTTP.3.0")).open(i ? "POST" : "GET", e, 1),
	...
	(function (e, t) {
		...
		var r = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/,
			s = function (e, t, n) {
				...
				if (
					(i.httpOnly && (o += "; HttpOnly"), i.secure && (o += "; Secure"), i.sameSite)
				)
			...
			m = {
				...
				lookup: function (e) {
					var t,
						n =
							e.htmlTag || ("undefined" != typeof document ? document.documentElement : null)
					return (
						n && "function" == typeof n.getAttribute && (t = n.getAttribute("lang")), t
					)
				},
			},
			y = {
			...
			init: function (n, i) {
				function o(t, i, o) {
					...
					if (0 !== i.length) {
						...
						if (
							(i.indexOf(";") === i.length - 1 && (i = i.substr(0, i.length - 2)),
							"html" === s)
						)
  ...
  */ !(function () {
			...
			function (e) {
				e.exports = {
					...
					cast:
						'<path d="M2 16.1A5 5 0 0 1 5.9 20M2 12.05A9 9 0 0 1 9.95 20M2 8V6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-6"></path><line x1="2" y1="20" x2="2.01" y2="message-square"></line>',
					"check-circle":
			...
			function (e, t, n) {
				...
				e.exports = function (e, t, n, u, f, v, b) {
					...
					if (
						...
						if (
							((w = { values: k("values"), keys: v ? A : k("keys"), entries: k("entries") }),
							b)
						)
	...
	(function (e) {
		...
		e.fn.TouchSpin = function (n) {
			...
			return this.each(function () {
				...
				function C() {
					switch (
						(clearTimeout(f), clearTimeout(d), clearInterval(p), clearInterval(h), v)
					) {
						case "up":
								...
								? ("" !==
								  ...
								  g.on("mousewheel.touchspin DOMMouseScroll.touchspin", function (e) {
										if (r.mousewheel && g.is(":focus")) {
											var t =
												e.originalEvent.wheelDelta || -e.originalEvent.deltaY || -e.originalEvent.detail
