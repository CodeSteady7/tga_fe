	...
	return (
		<BrowserRouter>
			<Routes>
				...
				/>
				<Route
					path="/manager/laporanaudit/view"
					element={
						<PrivateRoute>
							{' '}
							<FormLaporan />
