...
$(function () {
	...
	if (htmlAlert.length) {
		htmlAlert.on("click", function () {
			Swal.fire({
				...
				focusConfirm: false,
				confirmButtonText:
					feather.icons["thumbs-up"].toSvg({ class: "font-medium-1 me-50" }) + "Great!",
	...
	if (success.length) {
		success.on("click", function () {
			...
			// att.value = "modal"
			// att = "modal"
			// let tes = document.getElementById("type-success")
			// tes.setAttributeNode(att)
		})
	}
