										...
										<div className="card">
											<div className="card-header border-bottom">
												<h4 className="card-title">
													DETAIL FORM BORANG AUDIT {formatScope(auditDetail.scope_type)} INTERNAL
												</h4>
											</div>
											<div className="card-body mt-2">
												<div className="row">
													<div className="col-8 ">
														<p className="">
															<strong>No Dokumen</strong> : {auditDetail.document_no}
														</p>
													</div>
													<div className="col-4 ">
														<p className="">
															<strong>Tanggal Audit</strong> :{' '}
															{format(new Date(auditDetail.created_at), 'dd-MM-yyyy')}
														</p>
													</div>
													<div className="col-12 ">
														<p className="">
															<strong>Deskripsi Temuan</strong> :{' '}
															{AuditLib.findingCatgoryText(auditDetail.category)}{' '}
														</p>
													</div>
													<div className="col-12 ">
														<p className="">
															<strong>
																{auditDetail.scope_type === 'academic' ? 'Program Studi' : 'Unit'}
															</strong>{' '}
															: {auditDetail.audit_form.department_name}{' '}
														</p>
													</div>
												</div>
											</div>
													...
													<thead>
														...
														<tr>
															<td height={'100px'} valign={'top'} colSpan={2}>
																{auditDetail.finding_description}
															</td>
														</tr>
														<tr>
														...
														<tr>
															<td height={'100px'} valign={'top'} colSpan={2}>
																{auditDetail.root_caused_description}
															</td>
														</tr>
														<tr>
														...
														<tr>
															<td height={'100px'} valign={'top'} colSpan={2}>
																{auditDetail.consequence_description}
															</td>
														</tr>
													</thead>
												</table>
															...
															<tr>
																<td height={'100px'} valign={'top'} colSpan={2}>
																	...
																	<p className="text-danger">
																		Anda hanya dapat mengisi instrument satu kali. Pastikan mengisi
																		dengan benar!
																	</p>
													...
													<table className="dt-multilingual table table-bordered">
														<thead>
															...
															<tr>
																<td>
																	<p>
																		<strong>Nama Auiditee</strong>
																	</p>
																	<p>{auditDetail.auditee_name}</p>
																	<p>
																		Update Pada{' '}
																		{format(new Date(auditDetail.updated_at), 'dd MM yyyy')}
																	</p>
																</td>
															</tr>
														</thead>
