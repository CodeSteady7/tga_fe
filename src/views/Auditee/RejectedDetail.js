                                        ...
                                        <div className="col-12">
                                            <div className="card">
                                                ...
                                                <div className='card-body mt-2'>
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-4 '>
                                                            <p className=''><strong>Tanggal Audit</strong>  : {format(new Date(auditDetail.created_at), "dd MMM yyyy")}</p>
                                                        </div>
                                                        <div className='col-12 '>
                                            ...
                                            <div className='card'>
                                                ...
                                                <div className='card-body'>
                                                    ...
                                                    <p>Dibuat Pada {format(new Date(auditDetail.created_at), "dd MMM yyyy")}</p>
                                                </div>
                                            </div>
                                            <div className='card'>
                                                <div className="card-datatable">
                                                        ...
                                                        <thead>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <p>Update Pada {format(new Date(auditDetail.updated_at), "dd MMM yyyy")}</p>
                                                                </td>
                                                            </tr>
                                                        </thead>
                                                    </table>
