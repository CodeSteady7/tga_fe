	...
	return (
		<div className="card-datatable">
			<table className="dt-multilingual table">
				...
				<tbody>
					{typeof audits.data != 'undefined' && audits.data.length > 0 ? (
			...
			<nav aria-label="Page navigation example" className="pt-1">
				<ul className="pagination justify-content-center">
					{typeof audits.links != 'undefined'
						? audits.links.map((prop, index) => {
								return (
									<li
										key={index}
									...
									>
										<a
											className="page-link"
											data-page={`${prop.url !== null ? prop.url.split('=')[1] : null}`}
											onClick={e => paginationLink(e)}
										>
											{prop.label}
										</a>
									</li>
