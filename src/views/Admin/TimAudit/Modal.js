...
export default function Modal({ isOpen, setIsOpen, fecthDataAudit }) {
	...
	const getUsers = async ({ role, pagination }) => {
		await User.getAll({ role, pagination })
			.then(res => {
						...
						<form id="">
							<div className="row gy-1 pt-75">
								<div className="col-12 col-md-6">
									...
									<Select options={periodOption} onChange={e => setPeriod(e.value)} />
								</div>
								<div className="col-12 col-md-6">
							...
							<div className="row  gy-1 pt-75">
								<div className="col-12 col-md-12">
									...
									<Select options={unitOption} onChange={e => getDetailUnit(e.value)} />
								</div>
								<div className="col-12 col-md-6">
									<label className="form-label" htmlFor="modalviewTimAuditEmail">
										Ruang Lingkup
									</label>
									<input type="text" readOnly className="form-control" value={scope} />
								</div>
								<div className="col-12 col-md-6">
									<label className="form-label" htmlFor="modalEditTaxID">
										Auditee
									</label>
									<input type="text" readOnly className="form-control" value={auditee} />
								</div>
							</div>
							<div className="row gy-1 pt-75">
								<div className="col-12 col-md-6">
								...
								<div className="col-12 col-md-6">
									...
									<Select options={auditorOption} onChange={e => setAuditor(e.value)} />
								</div>
								<div className="col-12 col-md-12">
									<label className="form-label" htmlFor="modalviewTimAuditCountry">
										Anggota Auditor
									</label>
									<Select options={auditorOption} isMulti onChange={handleMultiChange} />
								</div>
							</div>
